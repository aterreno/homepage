      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="glass-card p-8 rounded-xl mb-6">
            <h3 className="text-xl font-semibold mb-4 text-antonio-navy">Book a Meeting</h3>
            <InlineWidget url="https://calendly.com/aterreno/30min" styles={{ minWidth: '320px', height: '630px' }} />
          </div>
          <div className="glass-card p-8 rounded-xl mb-6">
